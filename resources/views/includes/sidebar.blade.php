c           <!-- left side start-->
    <div class="left-side sticky-left-side">
        ...
        <div class="logo-icon text-center">
            <a href="index.html"><img src="{{url('/public/images/logo_icon.png')}}" alt=""></a>
        </div>
        ...
        <div class="left-side-inner">
            ...
            <div class="visible-xs hidden-sm hidden-md hidden-lg">
                <div class="media logged-user">
                    <img alt="" src="{{url('/public/images/photos/user-avatar.png')}}" class="media-object">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="menu-list"><a href=""><i class="fa fa-book"></i> <span>PRODUCTOS</span></a>
                    <ul class="sub-menu-list">
                        ...
                        <li><a href="{{url('/productos')}}"> LISTADO PRODUCTOS</a></li>
